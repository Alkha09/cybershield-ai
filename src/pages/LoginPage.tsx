    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="hidden lg:flex lg:w-5/12 bg-slate-900 relative items-center justify-center">
        ...
        <div className="relative z-10 max-w-sm px-8">
          ...
          <h2 className="text-2xl font-bold text-white mb-3">CyberShield AI</h2>
          <p className="text-slate-400 text-sm leading-relaxed mb-8">
            Enterprise-grade phishing detection for security teams. Analyze URLs, emails, SMS, and documents in real-time.
          </p>
